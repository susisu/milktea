        ...
        tok_openParen.bind(function (open) {
            return tok_anyOperator.bind(function (op) {
                return tok_closeParen
                    .then(lq.pure(new tokens.Identifier(open.pos, op.name)));
            });
        })
    ));
        ...
        tok_openParen.bind(function (open) {
            return lq.choice([
                tok_dot.bind(function (dot) {
                    return tok_variable.bind(function (id) {
                        return tok_closeParen
                            .then(lq.pure(
                                new core.Application(
                                    open.pos,
                                    new core.Variable(dot.pos, "__readProp__"),
                                    new core.Literal(
                                        id.pos,
                    ...
                    return tok_variable.bind(function (id) {
                        return tok_closeParen
                            .then(lq.pure(
                                new core.Application(
                                    open.pos,
                                    new core.Variable(colon.pos, "__callMethod__"),
                                    new core.Literal(
                                        id.pos,
                                        new core.Value(core.DataType.STRING, id.name)
                                    )
                    ...
                    return tok_variable.bind(function (id) {
                        return tok_closeParen
                            .then(lq.pure(
                                new core.Application(
                                    open.pos,
                                    new core.Variable(bang.pos, "__writeProp__"),
                                    new core.Literal(
                                        id.pos,
                                        new core.Value(core.DataType.STRING, id.name)
                                    )
                    ...
                    return tok_variable.bind(function (id) {
                        return tok_closeParen
                            .then(lq.pure(
                                new core.Application(
                                    open.pos,
                                    new core.Variable(question.pos, "__hasProp__"),
                                    new core.Literal(
                                        id.pos,
                                        new core.Value(core.DataType.STRING, id.name)
                                    )
        ...
        return tok_variable.bind(function (id) {
            return lq.pure(function (obj) {
                return new core.Application(
                    ...
                    new core.Application(
                        colon.pos,
                        new core.Variable(colon.pos, "__:__"),
                        obj
                    ),
                    new core.Literal(
                        id.pos,
        ...
        return tok_variable.bind(function (id) {
            return lq.pure(function (obj) {
                return new core.Application(
                    ...
                    new core.Application(
                        bang.pos,
                        new core.Variable(bang.pos, "__!__"),
                        obj
                    ),
                    new core.Literal(
                        id.pos,
        ...
        return tok_variable.bind(function (id) {
            return lq.pure(function (obj) {
                return new core.Application(
                    ...
                    new core.Application(
                        question.pos,
                        new core.Variable(question.pos, "__?__"),
                        obj
                    ),
                    new core.Literal(
                        id.pos,
...
var lambdaExpr =
    tok_backslash.bind(function (lambda) {
        return tok_variable.many1().bind(function (args) {
            return tok_arrow
                .then(expression)
                .bind(function (body) {
...
var bindExpr = (function () {
    var binding =
        tok_variable.bind(function (id) {
            return tok_variable.many().bind(function (args) {
...
var definitionDecl = 
    lq.try(
        tok_variable.bind(function (id) {
            return tok_variable.many().left(tok_equal).bind(function (args) {
