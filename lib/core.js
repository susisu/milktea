    ...
    "eval": {
        ...
        "value": function (env, tailCall) {
            ...
            this.props.forEach(function (prop) {
                obj.data[prop[0]] = prop[1].eval(env, false);
            });
            return obj;
        }
    }
...
function ReadPropertyAccessor(pos, value, name) {
    Expression.call(this, pos);
    this.value = value;
    this.name  = name;
}
...
function CallMethodAccessor(pos, value, name) {
    Expression.call(this, pos);
    this.value = value;
    this.name  = name;
}
...
function WritePropertyAccessor(pos, value, name) {
    Expression.call(this, pos);
    this.value = value;
    this.name  = name;
}
...
function CheckPropertyAccessor(pos, value, name) {
    Expression.call(this, pos);
    this.value = value;
    this.name  = name;
}
