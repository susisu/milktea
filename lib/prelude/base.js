                    ...
                    function (f) {
                        ...
                        return new Value(
                            ...
                            arr.data.map(function (elem) {
                                return utils.unboxTailCall(f.data(elem));
                            })
                        );
                    }
                );
                        ...
                        return new Value(
                            ...
                            function (arr) {
                                ...
                                return arr.data.reduce(
                                    function (accum, elem) {
                                        var g = utils.unboxTailCall(f.data(accum));
                                        utils.assertType(g, DataType.FUNCTION);
                                        return utils.unboxTailCall(g.data(elem));
                                    },
                                    init
                                );
                            }
                        ...
                        return new Value(
                            ...
                            function (arr) {
                                ...
                                return arr.data.reduceRight(
                                    function (accum, elem) {
                                        var g = utils.unboxTailCall(f.data(elem));
                                        utils.assertType(g, DataType.FUNCTION);
                                        return utils.unboxTailCall(g.data(accum));
                                    },
                                    init
                                );
                            }
