    ...
    new Value(
        ...
        function (ovalue) {
            ...
            return new Value(
                ...
                function (name) {
                    utils.assertType(name, DataType.STRING);
                    return utils.hasProperty(obj, name.data) ? __true__ : __false__;
                }
            );
        }
    );

var __readPropertyOf__ = __flip__.data(__readProperty__);
var __callMethodOf__ = __flip__.data(__callMethod__);
var __writePropertyOf__ = __flip__.data(__writeProperty__);
var __checkPropertyOf__ = __flip__.data(__checkProperty__);

var __Object__proto__ = utils.createObject(new Value(DataType.OBJECT, null));
__Object__proto__.data["read"] =
    new Value(
        DataType.FUNCTION,
        function (obj) {
    ...
    new Value(
        ...
        function (cls) {
            ...
            Object.defineProperty(cls.data, "proto", {
                ...
                "configurable": true,
                "enumerable"  : true,
                "value": utils.createObject(__Object__proto__)
            });
            return cls;
        }
    );
...
function open(target) {
    Object.defineProperties(target, {
        ...
        "__createObject__": {
            "value": __createObject__
        },
        "__readProperty__": {
            "value": __readProperty__
        },
        "__callMethod__": {
            "value": __callMethod__
        },
        "__writeProperty__": {
            "value": __writeProperty__
        },
        "__checkProperty__": {
            "value": __checkProperty__
        },
        "__readPropertyOf__": {
            "value": __readPropertyOf__
        },
        "__callMethodOf__": {
            "value": __callMethodOf__
        },
        "__writePropertyOf__": {
            "value": __writePropertyOf__
        },
        "__checkPropertyOf__": {
            "value": __checkPropertyOf__
        },
